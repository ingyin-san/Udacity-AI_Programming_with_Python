...
def calculates_results_stats(results_dic):
    ...
    """    
    # dictionary for statistics of the results 
    results_stats_dic = dict()

    # initiate the values of counters in the dictionary 
    ...
    # iterating the results dictionary
    for key in results_dic:
        
        # count the number of images
        results_stats_dic["n_images"] += 1

        # labels match - counts matches
        ...
        if results_dic[key][3] == 1:
            ...
            # classifier label is a Dog AND pet image label is a Dog - 
            # counts the number of correct dog classifications
            if results_dic[key][4] == 1:
                results_stats_dic["n_correct_dogs"] += 1

        # pet image label is NOT a Dog - counts number of non-dog images
        else:
            results_stats_dic["n_notdogs_img"] += 1

            # classifier label is NOT a Dog AND pet image label is NOT a Dog - 
            # counts the number of correct NOT dog classifications
    ...
    # when no dog images were submitted 
    else:
    ...
    # when no 'not a dog' images were submitted 
    else:
